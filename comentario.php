...
?>
<form class="caja" role="form" name="update" action="php/comentario.php" method="post">
		<div class="form-group">
		  ...
		  <div class="form-group">
		    ...
		    <input  id="fg" type="text" class="form-control" id="comentario" name="comentario" value="" required>
		  </div>
